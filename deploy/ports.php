...
$ports[] = array('normal',  'TCP', '88',    'Kerberos');
...
$ports[] = array('normal',  'TCP', '465',   'SMTPS');
$ports[] = array('normal',  'TCP', '587',   'SMTP STARTTLS');
...
$ports[] = array('normal',  'TCP', '3478',  'STUN');
$ports[] = array('normal',  'UDP', '4569',  'IAX2');
$ports[] = array('normal',  'TCP', '5190',  'ICQ/AIM');
$ports[] = array('normal',  'TCP', '5222',  'XMPP Client');
$ports[] = array('normal',  'TCP', '5223',  'XMPP Client SSL');
$ports[] = array('normal',  'TCP', '5269',  'XMPP Server');
$ports[] = array('normal',  'TCP', '5280',  'XMPP Bosh');
$ports[] = array('normal',  'TCP', '5298',  'XMPP Presence');
$ports[] = array('normal',  'TCP', '5349',  'STUNS');
$ports[] = array('normal',  'UDP', '5349',  'STUNS');
$ports[] = array('normal',  'TCP', '5900',  'VNC');
$ports[] = array('normal',  'TCP', '6667',  'IRC');
$ports[] = array('normal',  'TCP', '7443',  'Openfire Meetings');
$ports[] = array('normal',  'TCP', '8000',  'Proxy/8000');
$ports[] = array('normal',  'TCP', '8080',  'Proxy/8080');
$ports[] = array('normal',  'TCP', '8154',  'Filesync');
$ports[] = array('normal',  'TCP', '9091',  'Openfire Console');
$ports[] = array('normal',  'TCP', '9443',  'ClearGLASS');
$ports[] = array('normal',  'TCP', '10000', 'Webmin');
$ports[] = array('normal',  'TCP', '32400', 'Plex');
